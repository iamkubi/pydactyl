...
class ClientTests(unittest.TestCase):
    ...
    def test_list_files(self, mock_api):
        ...
        self.api.client.servers.files.list_files(1)
        mock_api.assert_called_with(**expected)
    ...
    def test_list_files_with_path(self, mock_api):
        ...
        self.api.client.servers.files.list_files(1, '/foo')
        mock_api.assert_called_with(**expected)
    ...
    def test_download_file(self, mock_api):
        ...
        self.api.client.servers.files.download_file(2, 'backups/savegame.zip')
        mock_api.assert_called_with(**expected)
    ...
    def test_rename_file(self, mock_api):
        ...
        self.api.client.servers.files.rename_file(3, 'today.zip',
                                                  'yesterday.zip')
        mock_api.assert_called_with(**expected)
