...
class Client(PterodactylAPI):
    ...
    def list_servers(self):
        ...
        response = self._request_get('client')
        return response
    ...
    def get_server(self, server_id):
        ...
        """
        response = self._request_get('client/servers/%s' % server_id)
        return response
    ...
    def get_server_utilization(self, server_id):
        ...
        """
        response = self._request_get('client/servers/%s/utilization' % server_id)
        return response
    ...
    def send_console_command(self, server_id, cmd):
        ...
        """
        data = {'command': cmd}
        response = self._request_post('client/servers/%s/command' % server_id, data=data)
        return response
    ...
    def send_power_action(self, server_id, signal):
        ...
        data = {'signal': signal}
        response = self._request_post('client/servers/%s/power' % server_id, data=data)
        return response
