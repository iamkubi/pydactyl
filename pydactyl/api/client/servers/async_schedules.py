...
class AsyncSchedules(AsyncPterodactylAPI):
    """Async Pterodactyl Client Server Databases API."""

    async def list_schedules(self, server_id: str):
    ...
    async def create_schedule(self, server_id: str, name: str, minute: str,
    ...
    async def get_schedule_details(self, server_id: str, schedule_id: int):
    ...
    async def update_schedule(self, server_id: str, schedule_id: int, name: str,
    ...
    async def delete_schedule(self, server_id: str, schedule_id: int):
    ...
    async def create_task(self, server_id: str, schedule_id: int, action: str,
    ...
    async def update_task(self, server_id: str, schedule_id: int, task_id: int,
    ...
    async def delete_task(self, server_id: str, schedule_id: int, task_id: int):
    ...
    async def run_schedule(self, server_id: str, schedule_id: int):
