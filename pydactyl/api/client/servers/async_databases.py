...
class AsyncDatabases(AsyncPterodactylAPI):
    """Async Pterodactyl Client Server Databases API."""

    async def list_databases(self, server_id: str, include_passwords: bool = False,
    ...
    async def create_database(self, server_id: str, name: str, remote: str = '%'):
    ...
    async def rotate_database_password(self, server_id: str, database_id: str):
    ...
    async def delete_database(self, server_id: str, database_id: str):
