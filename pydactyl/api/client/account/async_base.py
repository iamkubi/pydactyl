...
class AsyncAccount(AsyncPterodactylAPI):
    """Class for interacting with the Pterodactyl Client API asynchronously.
    ...
    async def get_2fa_setup_code(self):
    ...
    async def update_email(self, email: str, password: str):
        ...
        response = await self._api_request(endpoint=endpoint, mode='PUT',
                                     data=data)
        return response

    async def update_password(self, current: str, new: str, new_confirm: str):
    ...
    async def api_key_delete(self, identifier):
